...
const options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'FestScout Streaming API',
      version: '1.0.0',
      description: 'Streaming / short-film API for self-hosted FestScout',
      contact: {
    ...
    servers: [
      {
        url: process.env.STREAMING_API_URL || `http://localhost:${process.env.PORT || 3002}`,
