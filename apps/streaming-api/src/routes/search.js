...
// Get trending videos
router.get('/trending', cacheMiddleware(300, 'search-trending'), async (req, res) => {
    try {
...
router.get('/popular', cacheMiddleware(600, 'search-popular'), async (req, res) => {
    try {
...
// Get categories
router.get('/categories', cacheMiddleware(3600, 'search-categories'), async (req, res) => {
    try {
