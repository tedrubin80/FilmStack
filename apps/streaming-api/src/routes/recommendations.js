 ...
 */
router.get('/trending', cacheMiddleware(300, 'rec-trending'), async (req, res) => {
    try {
        const { limit = 20 } = req.query;
 ...
 */
router.get('/popular', cacheMiddleware(600, 'rec-popular'), async (req, res) => {
    try {
        const { limit = 20 } = req.query;
 ...
 */
router.get('/related/:videoId', cacheMiddleware(600, 'rec-related'), async (req, res) => {
    try {
 ...
 */
router.get('/home', cacheMiddleware(600, 'rec-home'), optionalAuth, async (req, res) => {
    try {
